export default async function handler(req, res) {
  try {
    ...
    const dDay = Math.ceil((eventDate - new Date()) / 86400000);
    ...
    return res.status(200).json({ success: true, total, resumeCount, kpiPct, dDay: dDayText, slackStatus: slackResp.status });
  } catch (e) {
